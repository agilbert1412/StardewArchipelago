...
namespace StardewArchipelago.Extensions
{
    public static class GameLocationExtensions
    {
        private static readonly Dictionary<WarpRequest, WarpRequest> ExtraWarps = new()
        {
            ...
            {new WarpRequest(Game1.getLocationRequest("DeepWoods"), 20, 6, FacingDirection.Down), new WarpRequest(Game1.getLocationRequest("DeepWoodsMaxHouse"), 19, 24, FacingDirection.Down)}
        };
