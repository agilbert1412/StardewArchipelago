...
namespace StardewArchipelago.Locations.ShopStockModifiers
{
    ...
    {
        public CraftingRecipePurchaseStockModifier(ILogger logger, IModHelper helper, ArchipelagoClient archipelago, StardewItemManager stardewItemManager) : base(logger, helper, archipelago, stardewItemManager)
        {
        }
