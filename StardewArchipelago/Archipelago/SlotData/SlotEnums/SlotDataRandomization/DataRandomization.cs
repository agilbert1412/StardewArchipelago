...
namespace StardewArchipelago.Archipelago.SlotData.SlotEnums.SlotDataRandomization
{
    public class DataRandomization
    {
        ...
        public Dictionary<string, RandomizedFestivalData> FestivalData => _randomizedData.Festivals;
        public Dictionary<string, RandomizedVillagerData> VillagersData => _randomizedData.Villagers;
        public Dictionary<string, Dictionary<string, RandomizedShopItemData>> ShopsData => _randomizedData.Shops;
