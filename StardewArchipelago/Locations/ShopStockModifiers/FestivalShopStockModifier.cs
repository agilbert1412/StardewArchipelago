...
namespace StardewArchipelago.Locations.ShopStockModifiers
{
    public class FestivalShopStockModifier : ShopStockModifier
    {
        ...
        private bool IsItemKnownAsACheck(ShopItemData item, out string locationName, out string itemName)
        {
            ...
            if (item.IsRecipe)
            {
                var stardewItem = _stardewItemManager.GetItemByQualifiedId(item.ItemId) ?? _stardewItemManager.GetItemByQualifiedId($"{QualifiedItemIds.OBJECT_QUALIFIER}{item.ItemId}");
