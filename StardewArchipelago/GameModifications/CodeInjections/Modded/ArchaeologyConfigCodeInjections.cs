...
namespace StardewArchipelago.GameModifications.CodeInjections.Modded
{
    ...
    {
        private const double ARTIFACT_SPOT_MULTIPLIER = 2; // Default Value: 10
        private const double DIGGING_MULTIPLIER = 2; // Default Value: 5
        private const double PANNING_MULTIPLIER = 5; // Default Value: 5
        private const double WATER_SHIFTER_MULTIPLIER = 2.5; // Default Value: 2
