...
namespace StardewArchipelago.Stardew.NameMapping
{
    public class SocializingNameMapper : INameMapper, IRecipeNameMapper
    {
        ...
        private static readonly Dictionary<string, string> SocializingEnglishNamesToCraftIdsMap = SocializingCraftIDsToEnglishNamesMap.ToDictionary(x => x.Value, x => x.Key);
        ...
        {
            return SocializingEnglishNamesToCraftIdsMap.ContainsKey(itemName) ? SocializingEnglishNamesToCraftIdsMap[itemName] : itemName;
        }
