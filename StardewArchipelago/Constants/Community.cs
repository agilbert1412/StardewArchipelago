namespace StardewArchipelago.Constants
{
    public class Community
    {
        public static readonly string[] AllNames = new[]
        {
            ...
            "Kono Tyran", "Lady Redacted", "Liarose", "lordlou", "Madolinn", "Magnemania", "Marech", "Margot",
            "Mati", "Mav", "MeleneV", "mewlif", "Mistik", "Nada", "Noca", "N00byKing" /*, "NinoKito"*/,
            "Phar", "PoryGone", "ProfBytes", "RaspberrySpaceJam", "Relissa", "Rosalie", "Salzkorn", "SamanthaCoffin",
