...
namespace StardewArchipelago.Archipelago
{
    public class ChatForwarder
    {
        ...
        public ChatForwarder(IMonitor monitor, IModHelper helper, Harmony harmony, ArchipelagoClient archipelago, GiftHandler giftHandler, AppearanceRandomizer appearanceRandomizer)
        {
            _monitor = monitor;
            _helper = helper;
            _harmony = harmony;
