...
{
    public class StardewPants : StardewItem
    {
        public StardewPants(string id, string name, string description, int price, string displayName)
        ...
        {
            return $"{QualifiedItemIds.PANTS_QUALIFIER}{Id}";
        }
    }
}
