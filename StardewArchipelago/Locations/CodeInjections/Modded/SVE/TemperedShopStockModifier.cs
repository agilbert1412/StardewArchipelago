...
namespace StardewArchipelago.Locations.CodeInjections.Modded.SVE
{
    public class TemperedShopStockModifier : ShopStockModifier
    {
        ...
        public TemperedShopStockModifier(ILogger logger, IModHelper helper, StardewArchipelagoClient archipelago, StardewItemManager stardewItemManager, NameSimplifier nameSimplifier) : base(logger, helper, archipelago, stardewItemManager, nameSimplifier)
        {
            _logger = logger;
            _helper = helper;
